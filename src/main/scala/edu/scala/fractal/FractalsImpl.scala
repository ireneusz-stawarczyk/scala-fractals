...
import edu.scala.fractal.actor.ActorsFractals

/** Chooses specific handling of fractal algorithms, e.g., concurrent, distributed, 
  * single-threaded, etc.
  */
object FractalsImpl {
  def apply(width : Int, height : Int) : Fractals = ActorsFractals(width, height)
}